        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Empowering the future through innovative education, cutting-edge research, and transformative IT solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/edu" className="text-gray-300 hover:text-white transition-colors">EDU Division</Link></li>
              <li><Link to="/research" className="text-gray-300 hover:text-white transition-colors">Research Park</Link></li>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">info@xlogica.com</span>
              </div>
              <div className="flex items-center space-x-2">
