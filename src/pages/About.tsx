...
import backgroundImage from "../../public/Images/About page background/background_4.jpg";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Founded on the belief that technology and education can transform
              lives, we've built a comprehensive ecosystem of learning,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-blue-50 rounded-xl p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                To democratize access to cutting-edge technology education while
                advancing research that solves real-world problems and
            ...
            <div className="bg-emerald-50 rounded-xl p-8">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                ...
                creating a world where innovation thrives through the
                convergence of learning, discovery, and practical application.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Xlogica was founded with a vision to bridge the gap between
                  academic learning and industry requirements in emerging
                  technologies.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  2019 - EDU Division Launch
                </h3>
                <p className="text-gray-600">
                  Launched Xlogica EDU with our first AI/ML certification
                  program, training over 500 students in the first year.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  2020 - Research Park Establishment
                </h3>
                <p className="text-gray-600">
                  Established our Research Park division, focusing on AI
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  2021 - IT Solutions Division
                </h3>
                <p className="text-gray-600">
                  Expanded into enterprise solutions, helping businesses
                  leverage AI and cloud technologies for digital transformation.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Today, we serve over 5,000 students, conduct 150+ research
                  projects, and partner with leading global enterprises.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Former MIT professor with 15+ years in AI research and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Leading AI researcher with 50+ publications and expertise in
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Enterprise technology veteran with experience scaling solutions
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Constantly pushing boundaries and exploring new possibilities in
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Building bridges between academia, industry, and students to
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Maintaining the highest standards in education, research, and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Focusing on solutions that create real-world value and positive
                change in society.
              </p>
            </div>
          </div>
